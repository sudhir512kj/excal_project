...
function SHA1 (msg) {
	...
	return temp.toLowerCase();
        ...
        <center><h4><font color="white"><i>SHA1 Hash Generator  <br>The SHA produces a 160-bit representation of the message called the MessageDigest.</i></font></h4></center>
        
<form role="form">
  <div class="form-group" style="margin-top:50;margin-left:300;">
    <label for="input_string"><h4><font color="white">Enter a String to be Converted into a SHA1 (checksum) :</font></h4>
        <textarea class="form-control" rows="3" style="height:150;width:700;" onkeyup="this.form.hash.value = SHA1(this.form.decoded.value)" name="decoded"></textarea></label>
  </div>
  <br /><br />  
    <div class="form-group" style="margin-top:2;margin-left:300;">
       <label for="input_string"><h4><font color="white">SHA1 :</font></h4>
